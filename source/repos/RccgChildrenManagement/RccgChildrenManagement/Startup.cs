...
namespace RccgChildrenManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RccgDbContext>(opts =>
           opts.UseSqlServer(Configuration.GetConnectionString("Rrccg")));
            services.AddScoped<IRccgRepository, RccgRepository>();
