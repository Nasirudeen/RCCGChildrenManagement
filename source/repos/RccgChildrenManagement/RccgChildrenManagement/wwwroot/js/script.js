$("#num-of-kids").change(function () {
    ...
    for (var count = 1; count <= amount; count++) {
        firstnames +=
            '<input class="form-control inputstl" name="ChildrenDetails[' + indexNo + '].ChildFirstName" type="text" placeholder="Kid\'s first name" required /><br />';
        lastnames +=
            '<input class="form-control inputstl" name="ChildrenDetails[' + indexNo + '].ChildLastName" type="text" placeholder="Kid\'s last name" required /><br />';
        dobs +=
            '<input class="form-control inputstl" name="ChildrenDetails[' + indexNo + '].dob" type="date" placeholder="Kid\'s date of birth" required /><br />';
        // classes += '<input name="cclass[]" type="text" placeholder="Kid\'s class" required /><br />'
        classes +=
            '<select class="form-control inputstl" name="ChildrenDetails[' + indexNo + '].Class">' +
